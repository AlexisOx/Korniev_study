...
def test_Logout(button=None):
    ...
    WebDriverWait(driver, 6).until(
        EC.element_to_be_clickable((By.CSS_SELECTOR, "button[id^='userNavDropdown']"))).click()

    WebDriverWait(driver, 3).until(
        EC.element_to_be_clickable((By.CSS_SELECTOR, "button[class*='dropdown-item']"))).click()
